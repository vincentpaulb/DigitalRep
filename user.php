...
<div class="container"> <!-- USC LOGO  -->
	<div class="row">
		...
		<div class="col-sm-4">
			...
			|
			<a href="login.php" style="font-family: Century"> Logout </a>
...
<div class="container">
	<div class="row"> <!-- BANNER -->
		...
		<div class="col-sm-4">
			...
			<form action="newuser1.php" method="POST" id="form1">
			<p style="font-family: Century; font-size: 25px">CREATE ACCOUNT</p>
				...
				<div class="input-group">
					...
					<input class="text" name="reppassword" required type="password" placeholder="Repeat Password"/>
				</div>
	
				<br>
				<input style="font-family: Century; font-size: 15px" class="btn" type="submit" value="SIGN UP" />
